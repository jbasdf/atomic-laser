...
EtherDream.findFirst(function(all) {
    ...
    EtherDream.connect(all[0].ip, all[0].port, function(conn) {
        ...
        function renderframe(phase, callback) {
            ...
            var rr = 45535; // 32760 + 32000 * Math.sin(phase / 60.5);
            var gg = 20000; // 32760 + 32000 * Math.sin(phase / 90.3);
            ...
            // for(var k=0; k<4; k++) {
            //  var c = Math.cos(k * Math.PI / 2);
            //  var s = -Math.sin(k * Math.PI / 2);
            //  drawline(framedata,
            ...
            // var k = secs;
            // var c = Math.cos(25 * Math.PI / 30.0);
            // var s = Math.sin(25 * Math.PI / 30.0);
            // drawline(framedata,
            //  -10000,0,
            //  20000*s*scale,20000*c*scale,
            //  rr,gg,bb
            //  //0,0,32768
            // );
            // var k = secs;
            // var nc = Math.cos(25 * Math.PI / 30.0);
            // var ns = Math.sin(25 * Math.PI / 30.0);
            // var c = Math.cos(5 * Math.PI / 30.0);
            // var s = Math.sin(5 * Math.PI / 30.0);
            // drawline(framedata,
            //  10000*ns*scale,10000*nc*scale,
            //  30000*s*scale,30000*c*scale,
            //  rr,gg,bb
            //  //0,0,32768
            // );
            // minutes
            ...
            // // hours
            // var k = hours;
            // var c = Math.cos(k * Math.PI / 6.0 + ((mins/60)*Math.PI / 6.0));
            // var s = Math.sin(k * Math.PI / 6.0 + ((mins/60)*Math.PI / 6.0));
            // drawline(framedata,
            //  0+xoffset,0,
